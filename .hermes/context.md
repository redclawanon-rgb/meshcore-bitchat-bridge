...
- `docs/ios-app-adapter-stub-gate5e.md` — Gate 5E iOS-first disabled/debug app adapter stub evidence; local iOS branch/commit and verification boundary
